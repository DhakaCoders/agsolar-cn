...
Constants->>
*/
defined('THEME_NAME') or define('THEME_NAME', 'agsolar');
...
if( !function_exists('cbv_theme_setup') ){
	...
	function cbv_theme_setup(){
	  ...
	  load_theme_textdomain( 'agsolar', get_template_directory() . '/languages' );
    ...
    //add_image_size( 'hmslider', 1368, 432, true );
      ...
      'cbv_mbmain_menu' => __( 'Mobile Main Menu', THEME_NAME ),
      'cbv_ftmain_menu' => __( 'Copyright Menu', THEME_NAME ),
		) );
